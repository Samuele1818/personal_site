...
const Hero: FC = () => {
 ...
 return (
  <section
   ...
   <MacMockup className='md:hidden absolute w-[80%] top-[55%] h-fit mx-auto left-10 right-0' />
   <div className='hidden md:block relative w-[48%]'>
    ...
    <MacMockup className='absolute top-[20%] md:-left-[160px] md:w-[140%] lg:left-[20px] lg:w-[80%] mx-auto h-fit' />
   </div>
